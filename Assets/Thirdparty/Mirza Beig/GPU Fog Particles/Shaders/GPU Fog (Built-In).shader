    ...
    SubShader
    {
        ...
        void surf(Input i, inout SurfaceOutput o)
        {
            ...
            float simplePerlin3D19 = snoise(
                (float3(i.uv_texcoord.xy, 0.0) + (_SimplexNoiseAnimation * _Time.y) + (ParticleStableRandom43 * 20.0)) *
                _SimplexNoiseScale);
            ...
            float cameraDepthFade87 = ((i.eyeDepth - _ProjectionParams.y - _CameraDepthFadeOffset) /
